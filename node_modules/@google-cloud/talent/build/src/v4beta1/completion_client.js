...
class CompletionClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.talent.v4beta1.Completion', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.completionStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.talent.v4beta1.Completion')
        ...
        for (const methodName of completionStubMethods) {
            const callPromise = this.completionStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=completion_client.js.map