...
class ApplicationServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listApplications: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'applications'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.talent.v4beta1.ApplicationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.applicationServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.talent.v4beta1.ApplicationService')
        ...
        for (const methodName of applicationServiceStubMethods) {
            const callPromise = this.applicationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    createApplication(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    getApplication(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    updateApplication(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteApplication(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listApplications(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listApplicationsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listApplications.createStream(this.innerApiCalls.listApplications, request, callSettings);
    }
    /**
    ...
    listApplicationsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listApplications.asyncIterate(this.innerApiCalls['listApplications'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=application_service_client.js.map