...
class JobServiceClient {
    ...
    constructor(opts) {
        ...
        const batchCreateJobsResponse = protoFilesRoot.lookup('.google.cloud.talent.v4beta1.JobOperationResult');
        const batchCreateJobsMetadata = protoFilesRoot.lookup('.google.cloud.talent.v4beta1.BatchOperationMetadata');
        const batchUpdateJobsResponse = protoFilesRoot.lookup('.google.cloud.talent.v4beta1.JobOperationResult');
        const batchUpdateJobsMetadata = protoFilesRoot.lookup('.google.cloud.talent.v4beta1.BatchOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.talent.v4beta1.JobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.jobServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.talent.v4beta1.JobService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.talent.v4beta1.JobService, this._opts, this._providedCustomServicePath);
