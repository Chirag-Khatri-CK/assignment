...
class TenantServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listTenants: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tenants'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.talent.v4beta1.TenantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.tenantServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.talent.v4beta1.TenantService')
        ...
        for (const methodName of tenantServiceStubMethods) {
            const callPromise = this.tenantServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    createTenant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    getTenant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    updateTenant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteTenant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listTenants(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listTenantsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listTenants.createStream(this.innerApiCalls.listTenants, request, callSettings);
    }
    /**
    ...
    listTenantsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTenants.asyncIterate(this.innerApiCalls['listTenants'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=tenant_service_client.js.map