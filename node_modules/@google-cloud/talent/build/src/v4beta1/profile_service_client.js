...
exports.ProfileServiceClient = void 0;
/* global window */
...
class ProfileServiceClient {
    ...
    constructor(opts) {
        ...
        this.pathTemplates = {
            applicationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/tenants/{tenant}/profiles/{profile}/applications/{application}'),
            profilePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/tenants/{tenant}/profiles/{profile}'),
            projectPathTemplate: new this._gaxModule.PathTemplate('projects/{project}'),
            projectCompanyPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/companies/{company}'),
            projectJobPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/jobs/{job}'),
            projectTenantCompanyPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/tenants/{tenant}/companies/{company}'),
            projectTenantJobPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/tenants/{tenant}/jobs/{job}'),
        ...
        this.descriptors.page = {
            listProfiles: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'profiles'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.talent.v4beta1.ProfileService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.profileServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.talent.v4beta1.ProfileService')
        ...
        for (const methodName of profileServiceStubMethods) {
            const callPromise = this.profileServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    createProfile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    getProfile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    updateProfile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteProfile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    searchProfiles(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listProfiles(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listProfilesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listProfiles.createStream(this.innerApiCalls.listProfiles, request, callSettings);
    }
    /**
    ...
    listProfilesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listProfiles.asyncIterate(this.innerApiCalls['listProfiles'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=profile_service_client.js.map