...
exports.CompanyServiceClient = void 0;
/* global window */
...
class CompanyServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listCompanies: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'companies'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.talent.v4beta1.CompanyService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.companyServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.talent.v4beta1.CompanyService')
        ...
        for (const methodName of companyServiceStubMethods) {
            const callPromise = this.companyServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    createCompany(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    getCompany(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    updateCompany(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteCompany(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listCompanies(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listCompaniesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listCompanies.createStream(this.innerApiCalls.listCompanies, request, callSettings);
    }
    /**
    ...
    listCompaniesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listCompanies.asyncIterate(this.innerApiCalls['listCompanies'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=company_service_client.js.map