...
exports.EventServiceClient = void 0;
/* global window */
 ...
 */
const gapicConfig = require("./event_service_client_config.json");
...
class EventServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.talent.v4beta1.EventService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.eventServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.talent.v4beta1.EventService')
        ...
        for (const methodName of eventServiceStubMethods) {
            const callPromise = this.eventServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    createClientEvent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
...
//# sourceMappingURL=event_service_client.js.map